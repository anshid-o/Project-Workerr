...
import 'package:workerr_app/presentation/user/screens/home/profile/information.dart';
import 'package:workerr_app/presentation/user/screens/home/profile/screen_report.dart';
import 'package:workerr_app/presentation/user/screens/home/profile/screen_specify_work.dart';
...
// final _page=UpdateProfile();
  ...
  build(BuildContext context) {
    ...
    while (usersList[i].email != user.email && i <= usersList.length) {
      i = i + 1;
    }
    // storeUser.
    return SafeArea(
                ...
                ProfileMenuWidget(
                  ...
                  onpress: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (ctx) => const ScreenSpacifyWork()));
                  },
                ),
                ProfileMenuWidget(
                  isSwitch: true,
